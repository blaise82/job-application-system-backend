export default {
  up: (queryInterface) => queryInterface.bulkInsert('Jobs', [
    ...
    {
      id: 'd0a011d9-447a-49a8-aebc-7e1b031afd62',
    ...
    {
      id: 'd0a031d9-447a-49a8-aebc-7e1b031afd62',
    ...
    {
      id: 'd0a041d9-447a-49a8-aebc-7e1b031afd62',
      title: '',
      description: "How to apply: All interested candidates to send email to Tracy@jlpp.co.za",
      createdAt: new Date(),
      updatedAt: new Date()
    ...
    {
      id: 'd0a071d9-447a-49a8-aebc-7e1b031afd62',
